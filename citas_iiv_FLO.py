...
TEXTOS = {
    ...
    "en": {
        ...
        "od": "👁️ OD", "oi": "👁️ OS",
        "farmaco": "Drug OD/OS", "dosis": "Number of doses OD/OS", "int_sem": "Interval {i} (weeks) OD/OS",
...
if ojo != t["elige"]:
    ...
    with col_od:
        if ojo in [t["derecho"], t["ambos"]]:
            ...
            dosis_od = st.number_input(t["dosis"], 0, 12, 0, key="d_od")
    ...
    with col_oi:
        if ojo in [t["izquierdo"], t["ambos"]]:
            ...
            dosis_oi = st.number_input(t["dosis"], 0, 12, 0, key="d_oi")
